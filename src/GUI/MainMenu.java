...
public class MainMenu extends JFrame {
    ...
    private JScrollPane scrollDiagrama;
    ...
    private void initComponents() {
        ...
        scrollDiagrama = new JScrollPane(panelDiagrama,
                JScrollPane.VERTICAL_SCROLLBAR_NEVER,
                JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollDiagrama.setPreferredSize(new Dimension(900, 140));
        scrollDiagrama.setBorder(BorderFactory.createTitledBorder("Diagrama de Hilos"));

        // Asignar paneles a Visualizador
        Visualizador.setPaneles(panelDiagrama, panelGrafo);
